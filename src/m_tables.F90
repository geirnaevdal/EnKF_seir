module m_tables
contains
subroutine tables(ens,enspar,nt,nrens,neq,nrpar,pri)
   use mod_parameters
   use m_agegroups
   use m_ensave
   use m_ensstd
